        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="vendor_name" className="block text-sm font-medium text-slate-700 mb-1">Vendor Name *</label>
                        <input
                            id="vendor_name"
                            type="text"
                            name="vendor_name"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="gst_number" className="block text-sm font-medium text-slate-700 mb-1">GST Number *</label>
                            <input
                                id="gst_number"
                                type="text"
                                name="gst_number"
