    ...
    return (
        <>
            ...
            <div
                ...
                className="bg-white mx-auto text-black font-sans text-[12px] leading-tight shadow-lg select-none flex flex-col relative"
                style={{
                    width: '210mm',
            ...
            >
                ...
                <div className="flex justify-center mb-2">
                    <div className="border border-black px-4 py-1 font-bold text-[13px] shadow-[2px_2px_0_rgba(0,0,0,0.1)]">
                ...
                <div className="border-2 border-black">
                    ...
                    <div className="flex border-b border-black">
                        <div className="w-[180px] p-1.5 pl-3 border-r border-black shrink-0 font-bold bg-gray-50/30">1. PARTY:</div>
                        <div className="p-1.5 pl-4 uppercase flex flex-col justify-center">
                            <div className="font-bold text-[13px]">M/s. {partyName}</div>
                    ...
                    <div className="flex border-b border-black">
                        <div className="w-[250px] flex border-r border-black shrink-0">
                            ...
                            <div className="p-1.5 pl-4 font-bold flex items-center">DIRECT</div>
                        </div>
                    ...
                    <div className="flex border-b border-black items-center py-0.5">
                        <div className="w-[180px] p-1.5 pl-3 border-r border-black shrink-0 font-bold bg-gray-50/30 self-stretch flex items-center">2 PURCHASE CONTRACT NO :</div>
                        <div className="p-1.5 pl-4 uppercase font-bold grow flex gap-6">
                            <span>MUML/{contract?.contract_id}/2025-2026</span>
                    ...
                    {/* 4. Variety */}
                    <div className="flex border-b border-black items-center py-0.5">
                        <div className="w-[180px] p-1.5 pl-3 border-r border-black shrink-0 font-bold bg-gray-50/30 self-stretch flex items-center">4. VARIETY</div>
                        <div className="p-1.5 pl-4 uppercase">{contract?.cotton_type} {contract?.quality}</div>
                    </div>

                    {/* 5. Purchase Rate */}
                    <div className="flex border-b border-black items-center py-0.5">
                        <div className="w-[180px] p-1.5 pl-3 border-r border-black shrink-0 font-bold bg-gray-50/30 self-stretch flex items-center">5. PURCHASE RATE</div>
                        <div className="p-1.5 pl-4 font-medium">Rs.{contract?.price}/- Spot Per Candy</div>
                    </div>
                    ...
                    <div className="flex border-b border-black py-1">
                        <div className="w-[180px] p-1.5 pl-3 border-r border-black shrink-0 font-bold bg-gray-50/30 self-stretch flex items-center">8 PARTY LOT</div>
                        <div className="p-1.5 pl-4 flex flex-col gap-1">
                            <div className="font-bold">LOT - {lot?.lot_number}</div>
                            <div>Invoice No: <b>{paymentData?.invoice_number}</b> &nbsp;|&nbsp; DT: {arrivalDate}</div>
                        </div>
                    </div>

                    {/* 9. Payment Value */}
                    <div className="flex border-b border-black py-1">
                        <div className="w-[180px] p-1.5 pl-3 border-r border-black shrink-0 flex items-center font-bold bg-gray-50/30 self-stretch">9 PAYMENT VALUE</div>
                    ...
                    <div className="flex border-t border-black min-h-[60px]">
                        ...
                        <div className="w-[40%] flex flex-col">
                            {/* Rows for alignment */}
                            <div className="h-[30px] border-b border-black flex justify-between items-end px-3 pb-1 text-[14px]">
                                <span>Rs</span>
                                <span className="font-mono font-bold">{fmt(netAmount)}</span>
                            </div>
                            <div className="text-right text-[11px] px-3 py-0.5 text-gray-500">CRF 07-284-0402</div>
                            <div className="flex justify-between items-center px-3 py-2 font-bold text-[15px] mt-auto">
                                <span>TOTAL &nbsp;&nbsp; Rs.</span>
                ...
                <div className="mt-4 flex justify-between items-end px-2">
                    {/* Timestamp Details */}
                    <div className="text-[11px] text-gray-500 text-left border-l-2 border-gray-300 pl-3">
                        <div className="font-bold uppercase tracking-wide mb-1">Digitally Timestamped</div>
                        <div>Date: <span>{currentDate}</span></div>
                        <div>Time: <span>{new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</span></div>
                        <div className="text-[9px] mt-1 text-gray-400">ID: {lot?.lot_id} | {contract?.contract_id}</div>
                    </div>
                    ...
                    <div className="text-center">
                        <div className="w-[200px] h-[50px] border-b border-dashed border-gray-400 mb-1 flex flex-col items-center justify-end pb-1">
                            <span className="text-[18px] font-cursive text-indigo-900 opacity-80" style={{ fontFamily: 'cursive' }}>
                                Authorized Sign
                            </span>
                        </div>
                        <div className="text-[11px] font-bold uppercase tracking-wider">Authorized Signatory</div>
                        <div className="text-[9px] text-gray-500">For Thiagarajar Mills Pvt Ltd</div>
                    </div>
                </div>
            </div>
        </>
