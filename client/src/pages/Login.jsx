        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden">
            ...
            <div className="relative z-10 bg-white/80 backdrop-blur-xl border border-white/50 p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label htmlFor="username" className="block text-slate-700 text-sm font-semibold mb-2">Username</label>
                        <input
                            id="username"
                            type="text"
                    ...
                    <div>
                        ...
                        <div className="flex justify-end mt-2">
                            <Link to="/reset-password" className="text-sm font-medium text-indigo-600 hover:text-indigo-500 hover:underline">
                                Forgot password?
                            </Link>
                        </div>
                    </div>
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 text-center text-xs text-slate-400">
                    ...
                    <div className="flex justify-center space-x-4">
                        <span className="bg-slate-50 px-3 py-1 rounded border border-slate-100">manager / manager</span>
                        <span className="bg-slate-50 px-3 py-1 rounded border border-slate-100">chairman / chairman</span>
                    </div>
                </div>
            </div>
        </div>
