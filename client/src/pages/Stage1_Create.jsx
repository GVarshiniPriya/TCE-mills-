                    ...
                    <div className="bg-white border border-slate-200 p-8 rounded-xl shadow-sm h-full flex flex-col">
                        ...
                        <div className="space-y-6 flex-grow">
                            <div>
                                ...
                                <input type="text" name="contract_id" placeholder="e.g. CON-001" value={formData.contract_id} onChange={handleContractChange} required className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-lg p-4 text-lg font-bold focus:ring-2 focus:ring-indigo-500 transition-all font-medium" />
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="quality" placeholder="e.g. Grade A" value={formData.quality} onChange={handleContractChange} className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-lg p-4 text-lg font-bold focus:ring-2 focus:ring-indigo-500 transition-all font-medium" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="quantity" placeholder="e.g. 100" value={formData.quantity} onChange={handleContractChange} className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-lg p-4 text-lg font-bold focus:ring-2 focus:ring-indigo-500 transition-all font-medium" min="0" step="1" />
                                </div>
                                <div>
                                    <label className="block text-slate-600 mb-1.5 font-bold text-xs uppercase tracking-wide">Price</label>
                                    <input type="number" name="price" placeholder="e.g. 55000" value={formData.price} onChange={handleContractChange} className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-lg p-4 text-lg font-bold focus:ring-2 focus:ring-indigo-500 transition-all font-medium" min="0" step="0.01" />
                                </div>
                            </div>

                            <div>
                                <label className="block text-slate-600 mb-1.5 font-bold text-xs uppercase tracking-wide">Entry Date</label>
                                <input type="date" name="entry_date" value={formData.entry_date} onChange={handleContractChange} className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-lg p-4 text-lg font-bold focus:ring-2 focus:ring-indigo-500 transition-all font-medium" />
                            </div>
