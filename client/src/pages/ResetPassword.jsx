    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden">
            ...
            <div className="relative z-10 bg-white/80 backdrop-blur-xl border border-white/50 p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md">
                ...
                <Link to="/login" className="flex items-center text-slate-500 hover:text-indigo-600 mb-6 transition-colors text-sm font-medium">
                    <ArrowLeft size={16} className="mr-1" /> Back to Login
                </Link>

                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Reset Password</h1>
                    <p className="text-slate-500 mt-2 text-sm">Enter your credentials to set a new password.</p>
                </div>
                ...
                {success && (
                    <div className="bg-emerald-50 border border-emerald-100 text-emerald-600 p-3 rounded-lg mb-6 text-sm text-center font-medium flex items-center justify-center animate-in fade-in">
                ...
                {!success && (
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-4">
                            <div>
                                <label className="block text-slate-700 text-sm font-semibold mb-1">Username</label>
                                <input
                                    type="text"
                                    name="username"
                                    className="w-full bg-white border border-slate-200 text-slate-900 rounded-lg px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition-all placeholder-slate-400 text-sm"
                            ...
                            <div>
                                <label className="block text-slate-700 text-sm font-semibold mb-1">New Password</label>
                                <input
                                    type="password"
                                    name="newPassword"
                                    className="w-full bg-white border border-slate-200 text-slate-900 rounded-lg px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition-all placeholder-slate-400 text-sm"
                            ...
                            <div>
                                <label className="block text-slate-700 text-sm font-semibold mb-1">Confirm New Password</label>
                                <input
                                    type="password"
