    ...
    return (
        <div className="max-w-7xl mx-auto pb-10 flex flex-col">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 mb-8 shadow-sm grid grid-cols-2 md:grid-cols-4 gap-6 items-start flex-shrink-0">
                ...
                <div>
                    <span className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Sequence</span>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="col-span-2">
                                                ...
                                                <input type="number" name="invoice_value" value={formData.invoice_value} onChange={handleChange} className="w-full bg-white border border-slate-300 text-slate-900 rounded-lg p-3 text-lg font-bold focus:ring-2 focus:ring-indigo-500" placeholder="0.00" required />
                                            </div>
                                        </div>
                                    </div>
